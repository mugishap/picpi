    ...
    ?>
        ...
        <div id="post<?=$postid?>" key='<?= $postid ?>' class="neumorphism rounded-xl m-1 sm:w-6/12 w-10/12 md:w-4/12 h-fit p-3">
            ...
            <div class="w-full mt-3 mb-3 flex items-center justify-around">
                ...
                <i class='bx bx-sm bx-comment w-fit h-full rounded hover:bg-blue-200 text-center box-border p-2 cursor-pointer'></i>
                <p class='relative bottom-4'><?=$commentCount?></p>
                </div>
            </div>
            <form action="?postid=<?= $postid ?>&userid=<?= $userid ?>&username='<?= $username ?>'" method="POST" class="w-full">
            <div class="left-48 bottom-16 emojis w-8">
            ...
            <input required type="text" name="comment-text" class="thecommentarea w-3/5 bg-gray-300 rounded p-2" placeholder="Comment here">
