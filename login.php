    ...
    <div class="form w-1/3 m-auto bg-gray-300 rounded p-4 mt-48">
        <form action="send.php" method="post" class="w-full flex flex-col">
            <div class="holders w-full flex flex-row items-center justify-between m-1">
                ...
                <input class="w-2/3 h-10" type="text" placeholder="Enter username" name="username" id="username" required>
            </div>
            <div class="holders w-full flex flex-row items-center justify-between m-1">
                <label for="password">Password: </label>
                <input class="w-2/3 h-10" type="password" placeholder="Enter password" name="password" id="password" required>
            </div>
